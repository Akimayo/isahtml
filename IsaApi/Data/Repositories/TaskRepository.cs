...
namespace Data.Repositories
{
    public class TaskRepository : ITaskRepository
    {
        ...
        public TaskRepository(ApplicationDbContext dbContext, IUserRepository userRepository)
        {
        ...
        public EntityPage<TaskEntity> GetMultiple(string authorIdentity, string search, int page,
            int perPage,
